...
namespace DoAnOOP
{
    class Program
    {
        ...
        public static void cau14()
        {
            ...
            //SELECT TenSach from Sach WHERE MSSACH IN
            //(SELECT MSSSACH FROM CHITIETPHIEUMUON GROUP BY MSSSACH HAVING COUNT(MSSSACH) >=
            //(SELECT TOP 1 COUNT(MSSSACH) AS SL FROM CHITIETPHIEUMUON GROUP BY MSSSACH ORDER BY SL DESC))
        ...
        public static void cau15()
        {
            ...
            //GROUP BY MONTH(NgayMuon) HAVING COUNT(MSDG) >=
            //(SELECT TOP 1 COUNT(MSDG) FROM MUONSACH WHERE YEAR(NgayMuon) = '2021' GROUP BY MONTH(NgayMuon))
        ...
        {
            //SELECT	* FROM SACH WHERE SoLuong BETWEEN 10 AND 20
            //AND MSSACH IN ( SELECT MSSSACH FROM CHITIETPHIEUMUON) 
        ...
        {
            //SELECT Month(A.NgayMuon),B.HoTen, Count(A.MSDG) FROM MUONSACH A , DOCGIA B
            //WHERE A.MSDG = B.MSDG AND YEAR(A.NgayMuon) = '2021'
